      ...
      <div className="container">
        <div className="page-head">
          <div>
            ...
            <h1 className="page-title">Report<br />history.</h1>
            <p className="page-desc">Signed in as {email}. Reopen saved scans and continue reviewing risks from the V2 report workspace.</p>
          </div>
        ...
        <section className="stat-grid" style={{ marginBottom: 18 }}>
          ...
          <div className="glass-card stat"><div className="stat-value">DG</div><div className="stat-label">Account</div></div>
        </section>
        ...
        <section className="grid grid-2">
          {reports.map((report, index) => (
            <button className="glass-card panel" key={report.report_id || `${report.project_name}-${index}`} onClick={() => openReport(report)} style={{ textAlign: 'left' }}>
